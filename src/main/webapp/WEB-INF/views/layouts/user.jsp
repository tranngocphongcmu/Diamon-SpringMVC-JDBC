		...
		<div class="topNav">
			<div class="container">
				<div class="alignR">
					...
					<a class="active" href="<c:url value="/assets/user/shophtmls/index.html" />"> <span class="icon-home"></span>
						Home
					</a> 
					...
					<a href="<c:url value="/assets/user/shophtmls/contact.html" />"><span class="icon-envelope"></span>
